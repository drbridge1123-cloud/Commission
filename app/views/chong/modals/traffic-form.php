    ...
    <div id="trafficModal" class="modal-overlay hidden">
        <div class="modal-content m-shell" style="max-width: 600px;">
            <div class="m-header">
                ...
                <button class="m-close" onclick="closeModal('trafficModal')">&times;</button>
            </div>
            <form id="trafficForm" onsubmit="submitTrafficCase(event)">
                ...
                <div class="m-body">
                    <div class="m-row cols-2">
                        <div>
                            ...
                            <input type="text" id="trafficClientName" class="m-input" required>
                        </div>
                        <div>
                    ...
                    <div class="m-row cols-1">
                        <div>
                            ...
                            <input type="text" id="trafficOffer" class="m-input" placeholder="e.g., DDS1 and dismiss">
                        </div>
                    </div>
                    ...
                    <div class="m-row cols-2">
                        <div>
                            ...
                            <select id="trafficDisposition" class="m-input" onchange="updateTrafficCommission()">
                    ...
                    <div class="m-row cols-2">
                        <div class="m-checkbox-row" style="border-top: none; margin-top: 0; padding: 0;">
                    ...
                    <div class="m-row cols-1" style="margin-top: 12px;">
                        <div>
                            ...
                            <textarea id="trafficNote" rows="2" class="m-input"></textarea>
                        </div>
                    </div>
                ...
                <div class="m-footer">
                    <button type="button" class="m-btn m-btn-secondary" onclick="closeModal('trafficModal')">Cancel</button>
                    <button type="submit" class="m-btn m-btn-primary">Save Case</button>
                </div>
            </form>
        </div>
    </div>
